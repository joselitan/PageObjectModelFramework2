...
class BasePage:
    ...
    def click(self, locator):
        if str(locator).endswith("_XPATH"):
            ...
            # self.driver.find_element("css_selector", configReader.readConfig("locators", locator)).click()
    ...
    def type(self, locator, value):
        if str(locator).endswith("_XPATH"):
            ...
            # self.driver.find_element("css_selector", configReader.readConfig("locators", locator)).send_keys(value)
    ...
    def select(self, locator, value):
        ...
        if str(locator).endswith("_XPATH"):
            ...
            # dropdown = self.driver.find_element("css_selector", configReader.readConfig("locators", locator))
